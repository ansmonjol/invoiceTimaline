...
module.exports = function *(models, channels, users, categorys) {
  const records = yield models.Time.bulkCreate([
    ...
    },
    {
      ...
      categoryGuid: categorys[0].guid, channelGuid: channels[2].guid, userGuid: users[1].guid
    },
    {
      date: new Date(), duration: 7,
      categoryGuid: categorys[2].guid, channelGuid: channels[3].guid, userGuid: users[2].guid
    },
    {
